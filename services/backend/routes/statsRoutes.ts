...
export function createStatsRoutes(db: Database): Router {
  ...
  router.get('/stats/revenue/:period?', async (req: Request, res: Response) => {
    try {
  ...
  router.get('/stats/appointments', async (req: Request, res: Response) => {
    try {
  ...
  router.get('/stats/clients', async (req: Request, res: Response) => {
    try {
