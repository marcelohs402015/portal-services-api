...
class ServiceRepository extends BaseRepository_js_1.BaseRepository {
    constructor(db) {
    ...
    getUpdateFields(dto) {
        ...
        if (dto.active !== undefined)
            fields.push('active');
        if (dto.requires_quote !== undefined)
            fields.push('requires_quote');
        return fields;
    }
    getUpdateValues(dto) {
        const values = [];
        ...
        if (dto.requires_quote !== undefined)
            values.push(dto.requires_quote);
        return values;
    }
