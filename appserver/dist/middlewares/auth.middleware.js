...
exports.validateApiKey = exports.userRateLimit = exports.canAccessResource = exports.requireAdmin = exports.optionalAuth = exports.requirePermission = exports.authorize = exports.authenticate = void 0;
...
const authenticate = async (req, res, next) => {
    try {
        ...
        if (JWTService_1.jwtService.isTokenExpiringSoon(token)) {
...
const requirePermission = (...requiredPermissions) => {
    return (req, res, next) => {
        ...
        const userPermissions = req.user.permissions || auth_types_1.RolePermissions[req.user.role] || [];
...
const requireAdmin = (req, res, next) => {
    ...
    const adminRoles = [auth_types_1.UserRole.ADMIN, auth_types_1.UserRole.SUPER_ADMIN];
...
const canAccessResource = (resourceType) => {
    return (req, res, next) => {
        ...
        if ([auth_types_1.UserRole.SUPER_ADMIN, auth_types_1.UserRole.ADMIN].includes(req.user.role)) {
            next();
            return;
        }
        ...
        if ([auth_types_1.UserRole.MANAGER].includes(req.user.role)) {
            next();
            return;
        }
