...
exports.apiKeyRateLimit = exports.createRateLimit = exports.authRateLimit = exports.strictRateLimit = exports.globalRateLimit = void 0;
...
class RateLimiter {
    ...
    createMiddleware(options) {
        const { windowMs = 60000, max = 100, message = 'Muitas requisições, por favor tente novamente mais tarde.', skipSuccessfulRequests = false, skipFailedRequests = false, keyGenerator = (req) => req.ip || 'unknown' } = options;
        return (req, res, next) => {
 ...
 */
exports.globalRateLimit = rateLimiter.createMiddleware({
 ...
 */
exports.strictRateLimit = rateLimiter.createMiddleware({
    windowMs: 15 * 60 * 1000, // 15 minutos
    max: 5, // 5 requisições
 ...
 */
exports.authRateLimit = rateLimiter.createMiddleware({
    windowMs: 15 * 60 * 1000, // 15 minutos
 ...
 */
exports.createRateLimit = rateLimiter.createMiddleware({
 ...
 */
exports.apiKeyRateLimit = rateLimiter.createMiddleware({
